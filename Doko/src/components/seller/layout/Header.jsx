...
import { Search, Bell, X, Check, Clock, Menu, Package, ShoppingBag, Users } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-gray-700 hidden sm:block">Seller Name</span>
          </div>
        </div>
      </div>
    </div>
