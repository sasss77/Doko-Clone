...
const ProfilePage = () => {
  ...
  const mockProfileStats = {
    ...
    loyaltyPoints: 1250,
    savedAddresses: 2,
    favoriteCategory: 'Musical Instruments'
  };
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold">{profileStats.totalOrders}</div>
                    <div className="text-sm text-blue-100">Orders</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">{formatPrice(profileStats.totalSpent)}</div>
                    <div className="text-sm text-blue-100">Total Spent</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">{profileStats.wishlistItems}</div>
                    <div className="text-sm text-blue-100">Wishlist</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">{profileStats.loyaltyPoints}</div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-6">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  View and track your orders here. You have {profileStats.totalOrders} total orders.
                </p>
                <Button
                  variant="nepal"
          ...
          {activeTab === 'wishlist' && (
            <Card className="p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Your Wishlist</h2>
              <div className="text-center py-12">
                <div className="text-6xl mb-4 opacity-50">❤️</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Saved Items</h3>
                <p className="text-gray-600 mb-6">
                  You have {profileStats.wishlistItems} items in your wishlist.
                </p>
                <Button
                  variant="nepal"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Get SMS updates for important orders</p>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Weekly updates on new products</p>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
